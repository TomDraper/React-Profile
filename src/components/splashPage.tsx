    ...
    return (
        <div ref={ref}className={className}>
            <div className="splashPageVignette center">
                ...
                <h3>Creating immersive gaming experiences, improving tooling to enable faster development and polishing with pixel perfect UI designed for a seamless user experience. <p>Created using React.</p></h3>
